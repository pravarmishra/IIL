...
export default function DistributorVisit(props) {
...
//   let results = await window.Platform.database.getDistributorVisit1({pageNumber:paginationModel.page});
...
console.log(resultArray);
  ...
  const onFilterChange1 = async(filterModel) => {
    ...
    try{  
      ...
      if(filterModel){
      const response = await window.Platform.database.getDistributorVisitFilter({filterField:filterModel.field,filterValue:filterModel.value,pageNumber:paginationModel.page,startDate:startDate,endDate:endDate,territoryName:territoryFilter })
      ...
      setRowCount(response.count[0].count)
        ...
        const response = await window.Platform.database.getDistributorVisitFilter({filterField:"territory",filterValue:"",pageNumber:paginationModel.page,startDate:startDate,endDate:endDate,territoryName:territoryFilter })
      console.log("respponse",response);
      const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
      setData(jsonArrayWithId)
      setRowCount(response.count[0].count)
  ...
  window.NotificationUtils.showError("Error While Recieving Data Please Wait and try again");  
    ...
    // setQueryOptions({ filterModel: { ...filterModel } });
        ...
        let result= [
            ...
            {
              field: "distributor_shop_name__c",
              headerName: "Distributor Shop Name",
              sortable: false,
              width: 200,
            //   filterable: false,
              valueGetter:(params)=>params.row?.distributor_shop_name__c,
              renderCell: (params) => {
                let val = params.row?.distributor_shop_name__c||"N/A";
                return <Tooltip title={val}>{val}</Tooltip>;
      ...
      // filterable: false, 
              ...
              sortable: false,
              valueGetter: params => params.row?.category__c || 'N/A',
              renderCell: params => {
      ...
      // filterable: false, 
        ...
        filterable: false, 
                ...
                width: 200,
                valueGetter:(params)=>params.row?.no_of_distributors__c||"N/A",
                renderCell: (params) => {
                  let val =  params.row?.no_of_distributors__c ||"N/A" ;
                  return <Tooltip title={val}>{val}</Tooltip>;
  
                },filterOperators: stringOperators 
              },
              {
                field: "total_no_of_retailers__c",
                headerName: "No of Retailers",
                sortable: false,
        filterable: false, 
  
                width: 200,
                valueGetter:(params)=>params.row?.total_no_of_retailers__c||"N/A",
                renderCell: (params) => {
                  let val =  params.row?.total_no_of_retailers__c ||"N/A" ;
                  return <Tooltip title={val}>{val}</Tooltip>;
        ...
        filterable: false, 
                ...
                width: 200,
                valueGetter:(params)=>params.row?.total_annual_turnover_in_lacs_iil__c||"N/A",
                renderCell: (params) => {
                  let val =  params.row?.total_annual_turnover_in_lacs_iil__c ||"N/A" ;
                  return <Tooltip title={val}>{val}</Tooltip>;
              ...
              {
                field: "PRODUCT__C",
                headerName: "Brand Covered",
                sortable: false,
        filterable: false, 
  
                width: 200,
                valueGetter:(params)=>params.row?.PRODUCT__C||"N/A",
                renderCell: (params) => {
                  let val = params.row?.PRODUCT__C||"N/A" ;
                  return <Tooltip title={val}>{val}</Tooltip>;
  
                },filterOperators: stringOperators 
              }, 
            {
              field: "credit_limit_required_specify_amount_in__c",
              headerName: "Credit Limit",
              sortable: false,
      filterable: false, 

              width: 200,
              valueGetter:(params)=>params.row?.credit_limit_required_specify_amount_in__c||"N/A",
              renderCell: (params) => {
                let val =  params.row?.credit_limit_required_specify_amount_in__c ||"N/A" ;
                return <Tooltip title={val}>{val}</Tooltip>;
      ...
      filterable: false, 
          ...
          {
            field: "collection_target_discussion__c",
            headerName: "Collection Target Discussion",
            width: 200,
    filterable: false, 

            sortable: false,
            valueGetter: params => {
                const value = params.row?.collection_target_discussion__c||"N/A"
                return value
            },
            renderCell: params => {
              // console.log(params.row.quotation.attributes.shippingOrders.parent.id)
        ...
        {
            field: "sales_target_discussion__c",
            headerName: "Sales Target Discussion",
            width: 200,
    filterable: false, 

            sortable: false,
            valueGetter: params => {
                const value = params.row?.sales_target_discussion__c||"N/A"
                return value
            },
            renderCell: params => {
              // console.log(params.row.quotation.attributes.shippingOrders.parent.id)
        ...
        {
            field: "focus_product_discussion__c",
            headerName: "Product Discussion",
            width: 200,
    filterable: false, 
        ...
        {
            field: "market_development__c",
            headerName: "Market Development",
            width: 200,
    filterable: false, 

            sortable: false,
            valueGetter: params => {
                const value = params.row?.market_development__c||"N/A"
                return value
            },
            renderCell: params => {
              // console.log(params.row.quotation.attributes.shippingOrders.parent.id)
        ...
        {
            field: "distributor_feedback__c",
            headerName: "Distributor Feedback",
            width: 200,
    filterable: false, 

            sortable: false,
            valueGetter: params => {
                const value = params.row?.distributor_feedback__c||"N/A"
                return value
            },
            renderCell: params => {
              // console.log(params.row.quotation.attributes.shippingOrders.parent.id)
...
console.log("Current Date:check1");
  ...
  const response = await window.Platform.database.getDistributorVisitFilter({filterField:searchTerm?.field,filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:formattedStartDate,endDate:formattedCurrentDate,territoryName:territoryFilter })
  const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
  setData(jsonArrayWithId)
  // setData(response.items);
  setRowCount(response.count[0].count)  
...
console.log("Current Date:check2");
  ...
  const response = await window.Platform.database.getDistributorVisitFilter({filterField:"ytd",filterValue:searchTerm,pageNumber:paginationModel.page,startDate:formattedStartDate,endDate:formattedCurrentDate,territoryName:territoryFilter })
  const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
      setData(jsonArrayWithId)
      // setData(response.items);
      setRowCount(response.count[0].count)
...
setEndDate(formattedCurrentDate)
if(searchTerm){
  const response = await window.Platform.database.getDistributorVisitFilter({filterField:searchTerm.field,filterValue:searchTerm.value,pageNumber:paginationModel.page,startDate:formattedStartOfMonth,endDate:formattedCurrentDate,territoryName:territoryFilter })
  const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
  setData(jsonArrayWithId)
  // setData(response.items);
  setRowCount(response.count[0].count)  
}else{
  const response = await window.Platform.database.getDistributorVisitFilter({filterField:"mtd",filterValue:searchTerm,pageNumber:paginationModel.page,startDate:formattedStartOfMonth,endDate:formattedCurrentDate,territoryName:territoryFilter })
  const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
      setData(jsonArrayWithId)
      // setData(response.items);
      setRowCount(response.count[0].count)
...
console.log("Current Date:", formattedCurrentDate);
if(searchTerm){
const response = await window.Platform.database.getDistributorVisitFilter({filterField:searchTerm.field,filterValue:searchTerm.value,pageNumber:paginationModel.page,startDate:formattedCurrentDate,territoryName:territoryFilter })
const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
      setData(jsonArrayWithId)
      // setData(response.items);
      setRowCount(response.count[0].count)
}else{
const response = await window.Platform.database.getDistributorVisitFilter({filterField:"ftd",filterValue:searchTerm,pageNumber:paginationModel.page,startDate:formattedCurrentDate,territoryName:territoryFilter })
const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
      setData(jsonArrayWithId)
      // setData(response.items);
      setRowCount(response.count[0].count)
...
try{
  ...
  const response = await window.Platform.database.getDistributorVisitFilter({filterField:searchTerm.field,filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:startDate,endDate:endDate,territoryName:data })
  const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
  setData(jsonArrayWithId)
  // setData(response.items);
  setRowCount(response.count[0].count)  
  ...
  const response = await window.Platform.database.getDistributorVisitFilter({filterField:"territory",filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:startDate,endDate:endDate,territoryName:data })
  const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
  setData(jsonArrayWithId)
  // setData(response.items);
  setRowCount(response.count[0].count)
...
if(searchTerm){
  const response = await window.Platform.database.getDistributorVisitFilter({filterField:searchTerm.field,filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:formattedDate,endDate:endDate,territoryName:territoryFilter })
  const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
  setData(jsonArrayWithId)
  // setData(response.items);
  setRowCount(response.count[0].count)
  ...
  const response = await window.Platform.database.getDistributorVisitFilter({filterField:"territory",filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:formattedDate,endDate:endDate,territoryName:territoryFilter })
  const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
  setData(jsonArrayWithId)
  // setData(response.items);
  setRowCount(response.count[0].count)
...
const finalDateRangeFilter=async(data)=>{
  ...
  setEndDate1(formattedDate)
    ...
    if(searchTerm){
    const response = await window.Platform.database.getDistributorVisitFilter({filterField:searchTerm.field,filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:startDate,endDate:data?formattedDate:endDate,territoryName:territoryFilter })
    const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
    setData(jsonArrayWithId)
    // setData(response.items);
    setRowCount(response.count[0].count)  
    ...
    const response = await window.Platform.database.getDistributorVisitFilter({filterField:"territory",filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:startDate,endDate:data?formattedDate:endDate,territoryName:territoryFilter })
    const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
    setData(jsonArrayWithId)
    // setData(response.items);
    setRowCount(response.count[0].count)
...
const clearDateFilter=async()=>{
  ...
  if(searchTerm||territoryFilter){
    try{
    setLoading(true)
    const response = await window.Platform.database.getDistributorVisitFilter({filterField:searchTerm?searchTerm.field:"territory",filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:'',endDate:'',territoryName:territoryFilter })
    const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
    setData(jsonArrayWithId)
    // setData(response.items);
    setRowCount(response.count[0].count)
...
const clearTerritoryFIlter=async()=>{
  ...
  if(searchTerm||startDate||endDate){
    try{
    setLoading(true)
    const response = await window.Platform.database.getDistributorVisitFilter({filterField:searchTerm?searchTerm.field:"territory",filterValue:searchTerm?.value,pageNumber:paginationModel.page,startDate:startDate,endDate:endDate,territoryName:'' })
    const jsonArrayWithId = response?.data?.map((obj, index) => ({ ...obj, id: index + 1 }));
    setData(jsonArrayWithId)
    // setData(response.items);
    setRowCount(response.count[0].count)
  ...
  return (
    <>
      ...
      <StaffEditorPageContainer>
        <HeaderContainer>
          <Typography variant="h5">Distributor Visits</Typography>
