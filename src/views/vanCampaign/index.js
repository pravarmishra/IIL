        ...
        let result= [
            ...
            //   filterable: false,
              ...
              // filterOperators: ['Contains'],
                ...
                field: "products_promoted__c",
                headerName: "Product",
                sortable: false,
                width: 200,
              //   filterable: false,
                valueGetter:(params)=>params.row?.products_promoted__c,
                renderCell: (params) => {
                  let val = params.row?.products_promoted__c||"N/A";
                  return <Tooltip title={val}>{val}</Tooltip>;
              ...
              //   filterable: false,
                ...
                width: 200,
              //   filterable: false,
                valueGetter:(params)=>params.row?.season__c,
                renderCell: (params) => {
                  let val = params.row?.season__c||"N/A";
                  return <Tooltip title={val}>{val}</Tooltip>;
